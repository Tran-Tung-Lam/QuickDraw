...
def get_args():
    ...
    parser.add_argument("--data_path", type=str, default="E:/AI/QuickDraw-1/data", help="the root folder of dataset")
    parser.add_argument("--log_path", type=str, default="E:/AI/QuickDraw-1/tensorboard")
    parser.add_argument("--saved_path", type=str, default="E:/AI/QuickDraw-1/trained_models")
